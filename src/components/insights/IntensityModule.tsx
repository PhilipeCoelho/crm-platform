    ...
    return (
        <div className="flex flex-col gap-6 w-full animate-in fade-in duration-500">
            <div className="flex items-center">
                <h2 className="text-xl font-bold text-[#111827] dark:text-[#EAEAEA] tracking-tight">Intensidade de Contatos</h2>
                <QuickGuide
            ...
            <div className="bg-[#FFFFFF] dark:bg-[#141414] rounded-xl border border-[#E5E7EB] dark:border-[#262626] p-8 w-full">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h3 className="text-xl font-bold text-[#111827] dark:text-[#EAEAEA] tracking-tight">Faixas de Intensidade</h3>
                        <p className="text-sm text-[#6B7280] dark:text-[#8A8A8A] mt-1">Volume de deals por número de contatos</p>
                    </div>
                </div>
