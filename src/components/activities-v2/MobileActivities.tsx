...
export default function MobileActivities({ currency }: { currency: Currency }) {
  ...
  const handleTouchMove = useCallback((e: React.TouchEvent) => {
    if (touchStart !== null && (showNotes || showHistory)) {
  ...
  }, [touchStart, showNotes, showHistory]);
    ...
    <div style={{
      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            maxHeight: (showNotes || showHistory) ? 0 : 500,
            opacity: (showNotes || showHistory) ? 0 : 1,
            transform: (showNotes || showHistory) ? 'translateY(-12px) scale(0.96)' : 'translateY(0) scale(1)',
            overflow: 'hidden',
