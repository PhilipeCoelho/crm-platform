                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            ...
                                            ${contact.status === 'active' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' :
                                                    (contact.status === 'lead' || !contact.status) ? 'bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary' :
                                                        'bg-muted text-muted-foreground dark:bg-muted/20 dark:text-muted-foreground/60'}`}>
