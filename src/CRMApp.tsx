            ...
            >
                ...
                {isSidebarExpanded && (
                    <button
                        ...
                        className={`absolute right-2 top-3 p-1 rounded-md hover:bg-slate-100 dark:hover:bg-white/10 text-slate-400 hover:text-slate-900 dark:text-gray-400 dark:hover:text-white transition-colors ${isSidebarPinned ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}
                ...
                <div className={`flex flex-col w-full space-y-2 mt-auto pb-2 ${isSidebarExpanded ? 'items-start' : 'items-center'}`}>
                    ...
                    {/* User Avatar (Mini) */}
                    <div className={`flex items-center gap-3 mt-2 rounded-md border border-border/10 p-1 bg-slate-50 dark:bg-white/5 ${isSidebarExpanded ? 'w-full px-2' : 'w-8 justify-center border-none bg-transparent'}`}>
                        ...
                        <div className={`flex flex-col overflow-hidden transition-all duration-300 ${isSidebarExpanded ? 'opacity-100 w-auto' : 'opacity-0 w-0 hidden'}`}>
                            ...
                            <span className="text-[9px] text-slate-400 dark:text-gray-600 mt-1">v1.2 (Prod)</span>
                        </div>
                    </div>
                </div>
